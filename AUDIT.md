...
- **Branch protection:** `pitv-standalone` není chráněná. Pro veřejnou distribuci doporučeno vyžadovat PiTV Check před změnou release větve.
